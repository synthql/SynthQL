export const schema = {
    ...
    properties: {
        customer: {
            $ref: '#/$defs/table_customer',
        },
        actor: {
            $ref: '#/$defs/table_actor',
        },
        category: {
            $ref: '#/$defs/table_category',
        },
        film: {
            $ref: '#/$defs/table_film',
        },
        film_actor: {
            $ref: '#/$defs/table_film_actor',
        },
        film_category: {
            $ref: '#/$defs/table_film_category',
        },
        address: {
            $ref: '#/$defs/table_address',
        },
        city: {
            $ref: '#/$defs/table_city',
        },
        country: {
            $ref: '#/$defs/table_country',
        },
        inventory: {
            $ref: '#/$defs/table_inventory',
        },
        language: {
            $ref: '#/$defs/table_language',
        },
        payment: {
            $ref: '#/$defs/table_payment',
        },
        rental: {
            $ref: '#/$defs/table_rental',
        },
        staff: {
            $ref: '#/$defs/table_staff',
        },
        store: {
            $ref: '#/$defs/table_store',
        },
    },
    required: [
        'customer',
                ...
                columns: {
                    ...
                    properties: {
                        ...
                        last_update: {
                            ...
                            properties: {
                                type: {
                                    $ref: '#/$defs/pg_catalog.timestamptz',
                                },
                                selectable: {
                                    type: 'boolean',
                                    const: true,
                ...
                columns: {
                    ...
                    properties: {
                        ...
                        rating: {
                            ...
                            properties: {
                                type: {
                                    $ref: '#/$defs/public.mpaa_rating.enum',
                                },
                                selectable: {
                                    type: 'boolean',
                                    const: true,
